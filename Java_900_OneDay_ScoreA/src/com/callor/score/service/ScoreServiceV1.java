...
/*
 *  random 값으로 51~100까지 정수를 생성하여
 *  ScoreDto의 각 과목 요소에 할당하고
 *  List<ScoreDto>에 추가하기
 */
public class ScoreServiceV1 {
	/*
	 * ScoreServiceV1을 상속(extends) 하고 싶다
	 * 이때 V1에 선언된 public method는 별다른 코드변경 없이
	 * V2에서 그대로 사용할 수 있다
	 * 하지만 private으로 선언된 변수는 상속이 안된다
	 * score 객체를 V2에서 사용하기 위하여
	 * protected로 변경해준다
	 */
	...
	public void makeScore() {
		...
		/*
		 * 학번을 자동으로 생성하기 1. scores 에 추가된 성적표가 있는가 확인 2. 없으면 최초의 성적 이므로 230001 로 학번을 세팅
		 * 3. 있으면 가장 마지막 성적표의 학번을 조회하여 학번을 + 1 하여 새로운 학번을 생성하기
		 */
	...
	/*
	 * count 변수에 정수값을 전달받아 count 만큼 makeScore() 호출하여 count 만큼 성적데이터를 생성하고 scores에 추가
	 */
	...
	public void printScore() {
		...
		for (ScoreDto dto : scores) {
			...
			System.out.printf("%.2f\t", dto.getAvg());
			System.out.println("");
