...
public class ScoreB {
	public static void main(String[] args) {
		 ...
		 * ScoreService 클래스를 (설계도로하여) 사용하여 5개의 scores 배열을 "선언만" 한다
		 */
		ScoreService[] scores = new ScoreService[5];
		
		// 0은 철수, 1은 영희, 2는 민수, 3. 길동, 4. 꺽정
		// 객체 배열은 선만만 되어 있을때는 내부에 포함하는 변수, method를 사용할 수 없다
		...
		// scoreTotal 변수는 private으로 설정되어 있어서 변수에 값을 직접 참조(읽기) 할 수 없다
